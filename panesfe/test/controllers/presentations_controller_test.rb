...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { name: @presentation.name, published: @presentation.published, user_id: @presentation.user_id }
    end
  ...
  test "should update presentation" do
    patch :update, id: @presentation, presentation: { name: @presentation.name, published: @presentation.published, user_id: @presentation.user_id }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
